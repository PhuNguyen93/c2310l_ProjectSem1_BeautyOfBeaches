...
<html class="no-js" lang="en">
  ...
  <x-preloader/>
    ...
    <section class="cs_hero cs_style_1 cs_center  cs_primary_bg" style="background-image: url('https://plus.unsplash.com/premium_photo-1669748157617-a3a83cc8ea23?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D') ">
      <div class="container">
            ...
            <article class="cs_post cs_style_1">
              ...
              <div class="cs_post_info">
                <div class="cs_post_info_in">
                  ...
                  <h2 class="cs_post_title cs_fs_24 cs_semibold"><a href="{{ route('blogdetails') }}">Useful VS Code Esions Front- End Develop</a></h2>
            ...
            <article class="cs_post cs_style_1">
              ...
              <div class="cs_post_info">
                <div class="cs_post_info_in">
                  ...
                  <h2 class="cs_post_title cs_fs_24 cs_semibold"><a href="{{ route('blogdetails') }}">Designing Better Linke Website And Email</a></h2>
                  <p class="cs_post_subtitle">Lorem ipsum dolor sit amet, atomorum ds sosidon ium est as Id vim rrem princi pes suas molesti interpretaris</p>
                  <div class="cs_post_btns cs_gray_bg_1">
                    <a href="#">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
