                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <div class="shrink-0">
                                <div class="relative dropdown text-end">
                                    <div class="shrink-0">
                                        <div class="relative dropdown text-end">
                                            <h6 class="text-base font-medium transition-all duration-200 ease-linear text-slate-600 group-hover/items:text-custom-500 dark:text-zink-200 dark:group-hover/items:text-custom-500">
                                                <a href="{{ route('forgot-password') }}" class="text-inherit">Forgot Password?</a>
                                            </h6>
                                        </div>
                                    </div>
