...
<body>
    ...
    <section class="cs_hero cs_style_1 cs_center cs_ripple_activate cs_primary_bg" data-src="assets/images/1920x1080-hd-beach-khfbqt2io95uf0zy.jpg"
    ...
    <section>
        ...
        <div class="container">
            <div class="cs_section_heading cs_style_1 text-center">
                <h3 class="cs_section_title_up cs_ternary_font cs_accent_color cs_normal cs_fs_24">POPULAR DESTINATION
                </h3>
                <h2 class="cs_section_title cs_semibold cs_fs_56 mb-0 wow fadeInUp" data-wow-duration="0.8s"
    ...
    <section>
        <div class="container">
            <div class="cs_video_block cs_style_1 cs_bg_filed position-relative"
                ...
                <h2 class="cs_video_title cs_fs_60 cs_semibold cs_white_color position-absolute mb-0">Our Journey <br>
                    in Videos</h2>
    ...
    <footer class="cs_footer cs_style_1 cs_white_color cs_bg_filed cs_primary_bg"
        ...
        <div class="container">
            <div class="cs_footer_main">
                ...
                <div class="cs_footer_main_col">
                    <div class="cs_footer_widget">
                        <h3 class="cs_footer_widget_title cs_fs_24 cs_semibold cs_white_color">Online User</h3>
                        <ul class="cs_menu_widget">
                            <div class="container mt-5 text-center cs_blur_container">
                                <!-- Hiển thị tổng số lượng người đã truy cập vào website -->
                                <h4 class="cs_hero_subtitle cs_white_color cs_ternary_font cs_fs_25">
                                    Total Visits: {{ $totalVisits }}
                                </h4>
