                ...
                <div class="card-body">
                        ...
                        <table class="w-full border-separate table-custom border-spacing-y-1 whitespace-nowrap">
                            <thead class="text-left">
                                <tr
                                    ...
                                    <th class="px-3.5 py-2.5 first:pl-5 last:pr-5 font-semibold sort" data-sort="phone">
                                        phone</th>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-2.5">
                                            <img src="{{ asset($user->img) }}" alt="Avatar"
                                                class="w-10 h-10 rounded-full"> <!-- Hiển thị avatar -->
                                        </td>
                                        ...
                                        <td class="px-3.5 py-2.5">
                                            <div class="relative dropdown">
                                                ...
                                                <ul class="absolute z-50 hidden py-2 mt-1 ltr:text-left rtl:text-right list-none bg-white rounded-md shadow-md dropdown-menu min-w-[10rem] dark:bg-zink-600"
                                                    ...
                                                    <li>
                                                        <form action="{{ route('user.destroybin', $user->id) }}"
                                                            method="POST" style="display:inline;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
                    ...
                    <div class="flex flex-col items-center mt-8 md:flex-row">
                        <div class="mb-4 grow md:mb-0">
                            <p class="text-slate-500 dark:text-zink-200">Showing <b>{{ $users->count() }}</b> of
                                <b>{{ $users->total() }}</b> Results</p>
                        </div>
                        <ul class="flex flex-wrap items-center gap-2">
                            ...
                            @else
                                <li><a href="{{ $users->previousPageUrl() }}"
                            ...
                            @for ($i = 1; $i <= $users->lastPage(); $i++)
                                <li>
                                    <a href="{{ $users->url($i) }}"
                                        class="inline-flex items-center justify-center {{ $users->currentPage() == $i ? 'bg-custom-500 text-white' : 'bg-white text-slate-500 border border-slate-200' }} rounded px-4 py-2 hover:bg-custom-50">
                                        {{ $i }}
                                    </a>
                                </li>
                            @endfor
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="flex justify-end gap-2 mt-4">
                        ...
                        <button type="submit"
                            class="text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500">Add
                            User</button>
                    </div>
                </form>
            </div>
