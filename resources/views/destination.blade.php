    ...
    <section class="cs_hero cs_style_1 cs_center cs_ripple_activate cs_primary_bg"
        ...
        <div class="container">
            <div class="cs_hero_text text-center">
                <h1 class="cs_hero_title cs_white_color cs_fs_100 wow fadeInUp" data-wow-duration="0.8s"
                    data-wow-delay="0.2s">Destinations</h1>
            </div>
                    ...
                    <div class="cs_grid_item">
                        ...
                        <a href="{{ route('destinationdetails', ['id' => $beach->id]) }}"
                            ...
                            <div class="cs_card_content position-absolute">
                                ...
                                <p class="cs_card_subtitle cs_fs_18 cs_medium cs_white_color mb-0">{{ $beach->country }}
                                </p>
                            </div>
                        </a>
                    </div>
