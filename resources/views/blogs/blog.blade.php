                ...
                @foreach ($blogs as $blog)
                    <article class="cs_post cs_style_5">
                        <a href="{{ route('blogdetails', $blog->id) }}" class="cs_post_thumb cs_zoom">
                            <img src="{{ asset($blog->image_url) }}" alt="{{ $blog->title }}" class="w-100 h-100 cs_zoom_in">
                        ...
                        <a href="{{ route('blogdetails', $blog->id) }}" class="cs_post_btn cs_fs_18 cs_medium cs_primary_color">
