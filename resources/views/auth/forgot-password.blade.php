                ...
                <!-- Form gửi OTP -->
                    <form method="POST" id="send-otp-form" action="{{ route('sendOtpForReset') }}">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" required placeholder="Enter email" id="emailInput">
                        </div>
                ...
                <!-- Form xác thực OTP -->
                    ...
                    <form method="POST" id="verify-otp-form" action="{{ route('verifyOtp') }}">
                        ...
                        <div>
                            ...
                            <input type="text" name="otp" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500" required placeholder="Enter OTP" id="otpInput">
                        </div>
